...
final class HttpRequest implements Runnable {
    ...
    private void processThread() throws Exception {
         ...
         * 
         * If index.html is called but the wrong location, trigger 301 and adjust the
         * file call
         * 
        ...
        if (exists) {
            ...
            content = "Content-Type: " + getType(requestedFile) + CRLF;
            exists = true;
        } else if (!exists && moved && requestedFile.contains("testing_pic.png")) {
            status = "HTTP/1.1 301 Moved Permanently";
            requestedFile = "images/testing_pic.png";
            content = "Content-Type: " + getType(requestedFile) + CRLF;
            exists = true;
        } else {
